def build_classification_prompt(message: str) -> str:
    ...
    prompt = (
        ...
        "- greeting (sapaan santai awal atau ungkapan pembuka ingin bertanya seperti halo, hi, good morning, permisi, saya ingin tanya dulu, i want to ask a question)\n"
        ...
        "Aturan:\n"
        "1. Jawab HANYA dengan satu kata kunci dari daftar di atas: faq, greeting, booking_inquiry, booking_request, complaint, cancellation, refund, reschedule, atau unknown.\n"
        ...
        "- \"Ganti jadwal menginap ke minggu depan.\" -> reschedule\n"
        "- \"Halo, selamat pagi.\" -> greeting\n"
        "- \"Hi, I want to ask some question.\" -> greeting\n"
        "- \"saya ingin tanya dulu\" -> greeting\n"
        "- \"Hello, can I ask you something?\" -> greeting\n"
        "- \"hei\" -> greeting\n"
